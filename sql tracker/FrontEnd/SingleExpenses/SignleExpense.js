...
async function getData(page, limit) {
  ...
  try {
    let res = await axios.get(  `http://localhost:4000/expense/getExpenses?page=${page}&limit=${limit}`,
      {
    ...
    document.getElementById( "Total").innerHTML = `Total Page = ${res.data.lastpage}`;
  } catch (error) {
